...
<?php $this->start("specific-script")?>
        ...
        <script src="<?=url("themes/adm/assets/js/product_register.js")?>" type="module" async></script>
        <script src="<?=url("themes/adm/assets/js/product_update.js")?>" type="module" async></script>
<?php $this->end(); ?>
